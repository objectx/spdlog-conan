...
class SpdlogConan(ConanFile):
    ...
    version = "20201126"
    url = "https://github.com/objectx/spdlog-conan"
    ...
    def source(self):
        ...
        self.run("cd spdlog && git checkout --detach 233e97c5e46d8f8e83a6ea06b2dc8db804a4aed4")
        os.rename("spdlog", self._source_subfolder)
    # def source(self):
